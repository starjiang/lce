...
#include "../include/CCommMgr.h"
#include "../include/CH2ShortT3PackageFilter.h"
#include "../include/CRawPackageFilter.h"
#include "../include/CPackage.h"
#include "../include/CHttpPackageFilter.h"
#include "../include/CHttpParser.h"
#include "../include/CHttpResponse.h"
...
public:
    ...
    void setLen(uint16_t wLen)
    {
        m_wLen = htons(wLen);
    }
    void setSeq(uint32_t dwSeq)
    {
        m_dwSeq = htonl(dwSeq);
    }
    uint16_t getLen()
