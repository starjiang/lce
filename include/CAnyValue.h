...
#define MAX_VALUE_TYPE = 17
    ...
    struct DType
    {
        ...
        {
            Integer1 = 0, ///< tiny unint value (1�ֽ�)
            Integer2 = 1, ///< small unint value (2�ֽ�)
            Integer4 = 2, ///< unsigned integer value(uint32)(4�ֽ�)
            Integer8 = 3, ///< big unsigned interger value(uint64)(8�ֽ�)
            Integer = Integer8,
            String1 = 4, ///< string value	//1���ֽڱ�ʾ����
            String2 = 5, ///< string value	//2���ֽڱ�ʾ����
            String4 = 6, ///< string value	//4���ֽڱ�ʾ����
            String = String4,
            ...
            Bool = 11,      /// bool
            Null = 12,      /// null
            SInteger1 = 13, ///< tiny int value (1�ֽ�)
            SInteger2 = 14, ///< small int value (2�ֽ�)
            SInteger4 = 15, ///< signed integer value(int32)(4�ֽ�)
            SInteger8 = 16, ///< signed integer value(int64)(8�ֽ�)
            SInteger = SInteger8,
        };
    };
    ...
    public:
        CAnyValue()
            : m_ucType(DType::Null), m_ucSubType(DType::Null), m_bInit(false), m_bHasData(false)
        {
            init();
            m_value.integer = 0;
        }
        ...
        CAnyValue(const bool bValue)
            : m_ucType(DType::Bool), m_ucSubType(DType::Bool), m_bInit(false), m_bHasData(bValue)
        {
            init();
        ...
        CAnyValue(const char cValue)
            : m_ucType(DType::Integer), m_ucSubType(DType::Integer1), m_bInit(false), m_bHasData(cValue == 0 ? false : true)
        {
            init();
        ...
        CAnyValue(const unsigned char ucValue)
            : m_ucType(DType::Integer), m_ucSubType(DType::Integer1), m_bInit(false), m_bHasData(ucValue == 0 ? false : true)
        {
            init();
        ...
        CAnyValue(const unsigned short wValue)
            : m_ucType(DType::Integer), m_ucSubType(DType::Integer2), m_bInit(false), m_bHasData(wValue == 0 ? false : true)
        {
            init();
        ...
        CAnyValue(const short shValue)
            : m_ucType(DType::Integer), m_ucSubType(DType::Integer2), m_bInit(false), m_bHasData(shValue == 0 ? false : true)
        {
            init();
        ...
        CAnyValue(const int iValue)
            : m_ucType(DType::Integer), m_ucSubType(DType::Integer4), m_bInit(false), m_bHasData(iValue == 0 ? false : true)
        {
            init();
        ...
        CAnyValue(const unsigned int uiValue)
            : m_ucType(DType::Integer), m_ucSubType(DType::Integer4), m_bInit(false), m_bHasData(uiValue == 0 ? false : true)
        {
            init();
        ...
        CAnyValue(const long lValue)
            : m_ucType(DType::Integer), m_ucSubType(DType::Integer8), m_bInit(false), m_bHasData(lValue == 0 ? false : true)
        {
            init();
        ...
        CAnyValue(const unsigned long ddwValue)
            : m_ucType(DType::Integer), m_ucSubType(DType::Integer8), m_bInit(false), m_bHasData(ddwValue == 0 ? false : true)
        {
            init();
        ...
        CAnyValue(const long lValue)
            : m_ucType(DType::Integer), m_ucSubType(DType::Integer4), m_bInit(false), m_bHasData(lValue == 0 ? false : true)
        {
            init();
            m_ucType = lValue < 0 ? DType::SInteger : DType::Integer;
            m_value.integer = lValue;
        ...
        CAnyValue(const unsigned long dwValue)
            : m_ucType(DType::Integer), m_ucSubType(DType::Integer4), m_bInit(false), m_bHasData(dwValue == 0 ? false : true)
        {
            init();
        ...
        CAnyValue(const unsigned long long ullValue)
            : m_ucType(DType::Integer), m_ucSubType(DType::Integer8), m_bInit(false), m_bHasData(ullValue == 0 ? false : true)
        {
            init();
        ...
        CAnyValue(const long long llValue)
            : m_ucType(DType::Integer), m_ucSubType(DType::Integer8), m_bInit(false), m_bHasData(llValue == 0 ? false : true)
        {
            init();
        ...
        CAnyValue(const float flValue)
            : m_ucType(DType::Float), m_ucSubType(DType::Float), m_bInit(false), m_bHasData(flValue == 0.0 ? false : true)
        {
            init();
        ...
        CAnyValue(const char *pszValue)
            : m_ucType(DType::String), m_ucSubType(DType::String4), m_bInit(false), m_bHasData(false)
        {
            init();
    ...
    public:
        int asInt() const
        {
            if (DType::Integer == m_ucType || DType::Bool == m_ucType || DType::SInteger == m_ucType)
                return static_cast<int>(m_value.integer);
            return 0;
        }
        ...
        {
            if (DType::Integer == m_ucType || DType::Bool == m_ucType || DType::SInteger == m_ucType)
                return static_cast<int64_t>(m_value.integer);
            return 0;
        }
        ...
        {
            if (DType::Integer == m_ucType || DType::Bool == m_ucType || DType::SInteger == m_ucType)
                return static_cast<uint32_t>(m_value.integer);
            return 0;
        }
        ...
        {
            if (DType::Integer == m_ucType || DType::Bool == m_ucType || DType::SInteger == m_ucType)
                return static_cast<uint64_t>(m_value.integer);
            return 0;
        }
        ...
        {
            if (DType::Integer == m_ucType || DType::Bool == m_ucType || DType::SInteger == m_ucType)
                return m_value.integer == 0 ? false : true;
            return false;
        }
        ...
        {
            if (DType::Integer == m_ucType || DType::Bool == m_ucType || DType::SInteger == m_ucType)
                return static_cast<long long>(m_value.integer);
            return 0;
        }
        ...
        {
            if (DType::Integer == m_ucType || DType::Bool == m_ucType || DType::SInteger == m_ucType)
                return static_cast<char>(m_value.integer);
            return 0;
        }
        ...
        {
            if (DType::Integer == m_ucType || DType::Bool == m_ucType || DType::SInteger == m_ucType)
                return static_cast<unsigned char>(m_value.integer);
            return 0;
        }
        ...
        {
            if (DType::Integer == m_ucType || DType::Bool == m_ucType || DType::SInteger == m_ucType)
                return static_cast<unsigned short>(m_value.integer);
            return 0;
        }
        ...
        {
            if (DType::Integer == m_ucType || DType::Bool == m_ucType || DType::SInteger == m_ucType)
                return static_cast<short>(m_value.integer);
            return 0;
        }
        ...
        {
            if (DType::Integer == m_ucType || DType::Bool == m_ucType || DType::SInteger == m_ucType)
                return static_cast<unsigned long>(m_value.integer);
            return 0;
        }
        ...
        {
            if (DType::Integer == m_ucType || DType::Bool == m_ucType || DType::SInteger == m_ucType)
                return static_cast<long>(m_value.integer);
            return 0;
        }
        ...
        {
            if (DType::Integer == m_ucType || DType::Bool == m_ucType || DType::SInteger == m_ucType)
                return static_cast<unsigned int>(m_value.integer);
            return 0;
        }
        operator bool() const
        {
        ...
        {
            if (DType::Float == m_ucType)
                return static_cast<double>(m_value.flValue);
            return 0.0;
        }
        ...
        const CAnyValue &operator[](const int iIndex) const
        {
            if ((DType::Vector == m_ucType) && NULL != m_value.vec)
            {
                if (iIndex < (int)m_value.vec->size())
                    ...
                    throw Error("operator[inx]: index invalid");
            }
            else
                throw Error("operator[inx]: type invalid");
        }
    ...
    private:
        ...
        void assign(const this_type &rhs)
        {
            if (m_ucType == DType::String)
                delete m_value.buf;
            if (m_ucType == DType::Vector)
                delete m_value.vec;
            if (m_ucType == DType::Map)
                delete m_value.map;
