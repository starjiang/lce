...
namespace lce
{
	...
	public:
		CSocketBuf(const int iInitSize, const int iAllowMaxSize)
			: m_iDataBeginPos(0), m_iDataEndPos(0), m_iDataAllowMaxSize(iAllowMaxSize), m_iInitSize(iInitSize)
		{
		...
		CSocketBuf()
			: m_iDataBeginPos(0), m_iDataEndPos(0), m_iDataAllowMaxSize(0), m_iInitSize(0)
		{
			m_pszBuf = NULL;
		}
		...
		CSocketBuf(const CSocketBuf &rhs)
			: m_iDataBeginPos(0), m_iDataEndPos(0), m_iDataAllowMaxSize(0), m_iInitSize(0), m_pszBuf(NULL)
		{
			this->assign(rhs);
		}
